...
# Form implementation generated from reading ui file 'NMEA183toshp.ui'
#
# Created: Sun Feb 15 17:32:32 2009
    ...
    def Convert(self):
        try:
            ...
            if self.comboBox.currentText()=='Greek Grid':
                ...
                #t_srs.ImportFromProj4("+proj=tmerc +lat_0=0 +lon_0=24 +k=0.9996 +x_0=500000 +y_0=0 +ellps=GRS80 +towgs84=-199.87,74.79,246.62,0,0,0,0 +units=m +no_defs")
            ...
            #drv.DeleteDataSource(str(outShapeFile))'to Delete, το βρήκα κάπου στο ΝΕΤ
            
            if  self.radioButton.isChecked():
                layer = ds.CreateLayer(ds.GetName(), geom_type = ogr.wkbPoint, srs = t_srs)
                        #layer.CreateField(ogr.FieldDefn('name', ogr.OFTSTRING))
            # a sample NMEA sentence is $GPGGA,83713.345,4548.6217,N,838.0017,E,2,8,1.3,274.6,M,48,M,1,0000*77
...
#        
    ...
    def saveDialog(self):
        ...
        self.Savefilename = QtGui.QFileDialog.getSaveFileName(None,'Save data as new Shapefile',  home,  "Shapefile (*.shp)");
    ...
    def showDialog(self):
        ...
        self.Openfilename = QtGui.QFileDialog.getOpenFileName(None,"Open a NMEA183 file", home)
